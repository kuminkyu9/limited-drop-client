...
const OrdersTabMain = ({ orderList }: itemProps) => {
  return (
    <div className="space-y-4">
      {orderList.length == 0 ? <div className="flex h-52 items-center justify-center rounded border border-dashed border-gray-200 text-base text-gray-400">
        아직 주문 내역이 없습니다.
      </div> : orderList.map((item) => (
